...
WeatherLog::WeatherLog(const Date& date, const Time& time, int windSpeed, float ambientTemperature, float solarRadiation)
...
bool WeatherLog::operator<(const WeatherLog& other) const
{
